...
public final class Settings {
	...
	/**
        ...
        */
		 ...
		 * @hide
		 */
		public static final String STATUS_BAR_AOSIP_LOGO_SHOW = "status_bar_aosip_logo_show";

        /**
		 * Statusbar CyanideL logo on the lock screen
		 * @hide
		 */
		public static final String STATUS_BAR_AOSIP_LOGO_SHOW_ON_LOCK_SCREEN = "status_bar_aosip_logo_show_on_lock_screen";
         ...
         * @hide
         */
        public static final String STATUS_BAR_AOSIP_LOGO_HIDE_LOGO = "status_bar_aosip_logo_hide_logo";
         ...
         * @hide
         */
        public static final String STATUS_BAR_AOSIP_LOGO_NUMBER_OF_NOTIFICATION_ICONS = "status_bar_aosip_logo_number_of_notification_icons";
		 ...
		 * @hide
		 */
		public static final String STATUS_BAR_AOSIP_LOGO_COLOR_DARK_MODE = "status_bar_aosip_logo_color_dark_mode";

...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    private View mAosipLogoLeft, mLeftSide, mStatusIcons, mSignalCluster, mClock, mCenterClock, mNetworkTraffic, mAosipLogo;
    ...
    public void init() {
        mAosipLogoLeft = mView.findViewById(R.id.left_aosip_logo);
    ...
    private void applyMode(int mode, boolean animate) {
        ...
        if (animate) {
            ...
            anims.playTogether(
                    animateTransitionTo(mAosipLogoLeft, newAlphaBC),
            ...
            mAosipLogoLeft.setAlpha(newAlphaBC);

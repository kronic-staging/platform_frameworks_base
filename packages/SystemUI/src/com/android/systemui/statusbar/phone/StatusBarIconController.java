...
import com.android.internal.util.aosip.StatusBarColorHelper;
import com.android.internal.util.aosip.ColorHelper;
...
public class StatusBarIconController extends StatusBarIconList implements Tunable {
    ...
    private ImageView mAosipLogoKeyguard;
    private ImageView mAosipLogoKeyguardLeft;
    ...
    public StatusBarIconController(Context context, View statusBar, View keyguardStatusBar,
        ...
        mAosipLogo = (ImageView) statusBar.findViewById(R.id.aosip_logo);
        mAosipLogoLeft = (ImageView) statusBar.findViewById(R.id.left_aosip_logo);
        mAosipLogoKeyguard = (ImageView) keyguardStatusBar.findViewById(R.id.aosip_logo_keyguard);
        mAosipLogoKeyguardLeft = (ImageView) keyguardStatusBar.findViewById(R.id.left_aosip_logo_keyguard);
    ...
    public void hideNotificationIconArea(boolean animate) {
        ...
        if (mShowLogo && mLogoStyle == LOGO_LEFT) {
            animateHide(mAosipLogoLeft, animate);
        }
        if (mShowLogo && mLogoStyle == LOGO_RIGHT) {
            animateHide(mAosipLogo, animate);
        }
    }
    ...
    public void showNotificationIconArea(boolean animate) {
        ...
        animateShow(mCenterClockLayout, animate);
        if (mShowLogo && mLogoStyle == LOGO_LEFT) {
            animateShow(mAosipLogoLeft, animate);
        }
        if (mShowLogo && mLogoStyle == LOGO_RIGHT) {
    ...
    public void setLogoVisibility(boolean showLogo, boolean forceHide, int maxAllowedIcons) {
        ...
        mLogoStyle = Settings.System.getInt(resolver,
                Settings.System.STATUS_BAR_AOSIP_LOGO_STYLE, 1);
        if (forceHide && notificationIconsCount >= maxAllowedIcons) {
            forceHideByNumberOfIcons = true;
        }
        if (mLogoStyle == LOGO_LEFT) {
            mAosipLogoLeft.setVisibility(showLogo && !forceHideByNumberOfIcons ? View.VISIBLE : View.GONE);
            mAosipLogo.setVisibility(View.GONE);
        }
        if (mLogoStyle == LOGO_RIGHT) {
            mAosipLogo.setVisibility(showLogo && !forceHideByNumberOfIcons ? View.VISIBLE : View.GONE);
            mAosipLogoLeft.setVisibility(View.GONE);
        }
    ...
    public void showKeyguardLogo(boolean show) {
        ...
        if (mLogoStyle == LOGO_LEFT) {
            mAosipLogoKeyguardLeft.setVisibility(show ? View.VISIBLE : View.GONE);
            mAosipLogoKeyguard.setVisibility(View.GONE);
        }
        if (mLogoStyle == LOGO_RIGHT) {
            mAosipLogoKeyguard.setVisibility(show ? View.VISIBLE : View.GONE);
            mAosipLogoKeyguardLeft.setVisibility(View.GONE);
        }
    }
    ...
    private void applyIconTint() {
        ...
        if (mShowLogo && mLogoStyle == LOGO_RIGHT) {
            mAosipLogo.setImageTintList(ColorStateList.valueOf(getLogoTint(mTintArea, mAosipLogo, mLogoColor)));
        }
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(){
            @Override public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (mAnimateLogoColor) {
                    ...
                    if (mLogoStyle == LOGO_LEFT) {
                        mAosipLogoLeft.setImageTintList(ColorStateList.valueOf(blended));
                    }
                    if (mLogoStyle == LOGO_RIGHT) {
                        mAosipLogoLeft.setImageTintList(ColorStateList.valueOf(blended));
                    }
    ...
    public void updateLogoColor(boolean animate) {
        ...
        mAosipLogoLeft.setImageTintList(ColorStateList.valueOf(StatusBarColorHelper.getLogoColor(mContext)));
        mAosipLogo.setImageTintList(ColorStateList.valueOf(StatusBarColorHelper.getLogoColor(mContext)));
        updateKeyguardLogoColor();
    }

    private void updateKeyguardLogoColor() {
        mAosipLogoKeyguardLeft.setImageTintList(ColorStateList.valueOf(StatusBarColorHelper.getLogoColor(mContext)));
        mAosipLogoKeyguard.setImageTintList(ColorStateList.valueOf(StatusBarColorHelper.getLogoColor(mContext)));
    }
}
